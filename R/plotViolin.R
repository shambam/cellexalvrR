...
#' @param family pdf typing family (defaults to "Helvetica")
#' @title description of function plotViolin
#' @export 
setGeneric('plotViolin', ## Name
	function (x, gene, grouping, ofile=NULL, width=9, height=9, main=NULL, X11type= 'cairo', family="Helvetica"  ) { ## Argumente der generischen Funktion
