...
test_that( "cellexalvr save and load object" ,{
			...
			cellexalObj = loadObject(file.path(opath, '..','cellexalObj.RData'), 5 )
			...
			expect_true( ! file.exists(file.path(opath, '..', 'cellexalObj.RData.lock')), "lock file in the data folder removed as expected")
