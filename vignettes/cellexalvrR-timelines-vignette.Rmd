...
bossTime = cellexalObj@usedObj$timelines[["lastEntry"]]@gname
...
timeSubset1 = cellexalObj@usedObj$timelines[[1]]@gname

cellexalObj = addSelection( timeSubset2, cellexalObj )
timeSubset2 = cellexalObj@usedObj$timelines[[1]]@gname
...
cellexalObj = compareGeneClusters ( timeSubset1, timeSubset2, 
