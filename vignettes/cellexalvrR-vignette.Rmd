...
```{r, fig.show='hold',eval=T}
cellvr <- MakeCellexaVRObj( Marix(log2data, sparse=T),drc.list=proj.list,specie="mouse",cell.meta=cell.ids,facs.data=facs)
```
...
```{r,fig.show='hold',eval=T}
cell.vr.scr <- new("cellexalvr",data=Matrix(log2data,sparse=T),drc=list(tsne=tsne.proj))
cell.vr.scr
```
